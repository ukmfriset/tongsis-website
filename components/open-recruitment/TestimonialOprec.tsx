    ...
    <section className="py-24 px-4 bg-[#F2F2F2]">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <h2 className="mt-4 text-4xl md:text-5xl font-extrabold text-[#0D0D0D] tracking-tight">Testimoni Anggota</h2>
          <p className="mt-6 text-gray-600 max-w-2xl mx-auto text-lg leading-relaxed font-medium">
            Kata Mereka yang Udah Ngerasain Sendiri
          </p>
        </div>
                ...
                <div className="relative z-10 flex flex-col h-full justify-between">
                  <div>
                    ...
                    <div className="text-center">
                      ...
                      {/* PERBAIKAN: Menghapus line-clamp-6 dan menyesuaikan min-h agar ruang teks seragam */}
